"""
Django settings for PProgrammers project.
...
SECRET_KEY = 'iua$q4frd*4(89t-$!c@bgysl6gzu50%q(n+aff$8#61)%6)8c'
...
ROOT_URLCONF = 'PProgrammers.urls'
...
WSGI_APPLICATION = 'PProgrammers.wsgi.application'
